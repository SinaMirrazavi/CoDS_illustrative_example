...
if Option.check==0
 ...
 [A,X_initial,Option.check]=Construct_the_dynamcial_system(Poly,X_target,Option);
 if Option.check==0
       error('Program exit')
 end
...
[DDX_modulated,DX_modulated,X_modulated,F_modulated,Time_modulated]=  simulate_modulated_system(A,N_x,Poly,X_initial,X_target,X_C,X_L,Option);
 
plot_the_simualtions(DDX_modulated,DX_modulated,X_modulated,F_modulated,Time_modulated,Poly,X_initial,X_target,X_C,X_L,N_x,Option);
% % 
